...
class BootStrap {
    ...
    def init = { servletContext ->
		...
		def grupo11 = new ClassGroup(nameGroup:'Pecoras',description:'Viernes de juegos de azar',createAt: new Date(),userType:2,eventCreator : new EventCreator(), adminId : usuario11.id)
		...
		def grupo22 = new ClassGroup(nameGroup:'GrupoTenistas',description:'campeonatos',createAt: new Date(),userType:3,eventCreator : new EventCreator(), adminId : usuario22.id)
