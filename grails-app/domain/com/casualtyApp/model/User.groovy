...
//	def  String username
	...
	//static hasMany = [event:Event,classGroup:ClassGroup]//un usuario puede crear cero o muchos eventos,
	...
	//Default Constructor
	public User(){
		myGroups= new HashMap<Integer,ClassGroup>(MAX_GROUPS);
		myEvents= new HashMap<Integer,Event>(MAX_EVENTS);
	}
	
	//Constructor with all fields
	public User(int idUser, String username, String emailUser,
			Date createdAt, boolean isUnalConfirmed, HashMap<Integer,ClassGroup> myGroups,
	...
	def boolean addGroup(ClassGroup group){
	...
	def boolean removeGroup(ClassGroup group){
